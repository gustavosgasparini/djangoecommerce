...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('checkout', '0002_auto_20190307_1150'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_option', models.CharField(choices=[('pagseguro', 'PagSeguro'), ('paypal', 'PayPal')], max_length=50, verbose_name='Opção de pagamento')),
